...
/**********************************************************/
char array1[]=" Project Lead The Way       "; //the string to print on the LCD
char array2[]="Pascale,Rozmy,&Michelle     "; //the string to print on the LCD
...
void loop() 
{
  ...
  for (int positionCounter1 = 0; positionCounter1 < 27; positionCounter1++)
  {
